...
final class LoginController
{
    ...
    public function login(Request $request): Response
    {
        ...
        if (!$this->auth->attempt((string) $request->input('login', ''), (string) $request->input('password', ''))) return Response::text('Invalid credentials or account temporarily locked.', 422);
