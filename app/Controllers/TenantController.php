...
final class TenantController
{
    ...
    public function store(Request $request): Response
    {
        ...
        try {
            ...
            return Response::json(['data' => ['tenant_id' => $tenantId, 'admin_user_id' => $userId]], 201);
        } catch (Throwable $e) {
