...
$mikrotikClient=new RouterOsApiClient();
...
if(is_file($webRoutes)){
    ...
    if(is_callable($registerRoutes)) $registerRoutes($router,$loginController,$auth,$csrf,$authorize,$customerController,$customerServiceController,$csrfMiddleware,$mikrotikEnforcementAuditController,$mikrotikManualActionController,$tenantController);
}
